---
name: agents-md-creation
description: Generates hierarchical AGENTS.md structures for any codebase. Creates root-level lightweight guidance plus detailed sub-folder AGENTS.md files following JIT (Just-In-Time) indexing principles. Use when setting up AI coding agent guidance for a new project, restructuring existing AGENTS.md, or onboarding a codebase for AI-assisted development. Triggers on "create AGENTS.md", "generate AGENTS.md", "setup AI agent guidance", "hierarchical agents", "codebase documentation for AI".
---

# Skill: Hierarchical AGENTS.md Generation
