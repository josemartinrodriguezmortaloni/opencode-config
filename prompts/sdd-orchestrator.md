...
*Why?* Because human problems exist in human domains (refineries, hospitals, finance). If the code reflects the domain, when the domain evolves, you know exactly where to change. If it reflects the technology, every business change requires technical archaeology.
...
*Why?* Because evolution requires change. And change is only sustainable if it is local. If moving one piece brings down the building, the building cannot evolve.
